...
Add it to your iPhone home screen from Safari (Share → *Add to Home Screen*) to use
it like an app.

## Notes

- This is the browser build. Push and on-device prayer reminders are **not**
  included here — those require the native app.
- Prayer times are bundled and work offline. Events, announcements, and the
